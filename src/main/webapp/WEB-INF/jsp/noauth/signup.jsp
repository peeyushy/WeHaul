				...
				<div class="card">
					...
					<article class="card-body">
						<form>
							...
							<!-- form-group// -->
							<small class="text-muted">We'll never share your personal
								details with anyone else. By clicking the 'Register' button, you
								confirm that you accept our Terms of use and Privacy Policy. </small>
						</form>
					</article>
					<!-- card-body end .// -->
				</div>
